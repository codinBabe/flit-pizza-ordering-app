...
export default function SignUp() {
    ...
    return (
        <main className="p-8 md:p-12 mx-auto max-w-md text-center">
            <h1 className="font-semibold text-3xl animate-fade-in mb-8">Sign Up</h1>
            {userCreated && (
            ...
            <form className="my-1" onSubmit={handleFormSubmit}>
                ...
                <button className='text-white bg-primarybtn rounded-md' type='submit' disabled={creatingUser}>Submit</button>
                ...
                <div className="flex items-center justify-center gap-2 my-6">
                    ...
                    <Link className="bg-gradient-to-r from-yellow-500 to-red-500 animate-gradient text-white font-bold p-2 rounded-md" href={'/login'}>Login</Link>
                </div>
                <button type='button'
                    onClick={() => signIn('google', { callbackUrl: '/' })} className="text-black flex justify-center items-center gap-2 mt-5 border rounded-md">
