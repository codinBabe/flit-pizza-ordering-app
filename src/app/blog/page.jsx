...
export default function BlogPage() {
    return (
        <main className="p-12">
            <div className="flex sm:flex-col items-center gap-48">
                ...
                <img className="transition-transform duration-300 transform hover:scale-110 rounded-lg" src="/images/eating-pizza.jpg" alt="eating-pizza" width="450px" />
            </div>
            <div className="flex items-center gap-48">
                <img className="transition-transform duration-300 transform hover:scale-110" src="/images/pizza-with-tomato.png" alt="pizza-with-tomato" width="450px" />
                <div className="w-2/4 flex flex-col gap-3 leading-loose">
            ...
            <div className="flex items-center gap-48">
                ...
                <img className="transition-transform duration-300 transform hover:scale-110" src="/images/half-pizza.png" alt="sliced pizza" width="450px" />
            </div>
        </main>
    )
}